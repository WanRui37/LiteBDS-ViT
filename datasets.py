...
def build_dataset(is_train, args):
    ...
    if args.data_set == 'CIFAR':
        ...
        # dataset = datasets.Flowers102(args.data_path, split='train' if is_train else 'val', 
        ...
        # if is_train:
        #     dataset = pd.read_parquet(args.data_path + splits["train"])
        # else:
        #     dataset = pd.read_parquet(args.data_path + splits["validation"])
